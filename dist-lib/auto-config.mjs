import { Fragment as e, computed as t, createBlock as n, createCommentVNode as r, createElementBlock as i, createElementVNode as a, createTextVNode as o, createVNode as s, defineComponent as c, inject as l, normalizeClass as u, normalizeStyle as d, openBlock as f, ref as p, renderList as m, renderSlot as h, resolveDynamicComponent as g, toDisplayString as _, unref as v, watch as y, withCtx as b } from "vue";
//#region \0rolldown/runtime.js
var x = Object.create, S = Object.defineProperty, C = Object.getOwnPropertyDescriptor, w = Object.getOwnPropertyNames, T = Object.getPrototypeOf, E = Object.prototype.hasOwnProperty, D = (e, t) => () => (e && (t = e(e = 0)), t), O = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), k = (e, t) => {
	let n = {};
	...
	value: e,
	enumerable: !0
}) : n, e)), M = (e) => E.call(e, "module.exports") ? e["module.exports"] : A(S({}, "__esModule", { value: !0 }), e);
//#endregion
//#region src/utils/schema-parser.ts
function N(e) {
	return e.type === "boolean" ? "checkbox" : e.type === "number" || e.type === "integer" ? "number" : e.type === "object" ? "group" : e.type === "array" ? "array" : e.type === "string" ? Array.isArray(e.enum) && e.enum.length > 0 ? "select" : e.format === "textarea" ? "textarea" : "text" : "text";
}
function P(e) {
	if (e.type !== "array" || !e.items) return;
	let t = e.items.type;
	return t === "number" || t === "integer" ? "number" : "string";
}
function F(e) {
	if (Array.isArray(e.enum)) return e.enum.map((e) => ({
		label: String(e),
		value: String(e)
	}));
}
function I(e, t, n, r) {
	let i = n ? `${n}.${e}` : e, a = N(t), o = {
		key: e,
		path: i,
		label: t.title ?? e,
	...
	return a === "group" && t.properties && (o.children = L(t.properties, t.required ?? [], i)), o;
}
function L(e, t, n) {
	return Object.entries(e).map(([e, r]) => I(e, r, n, t.includes(e)));
}
function ee(e) {
	return e.type !== "object" || !e.properties ? [] : L(e.properties, e.required ?? [], "");
}
//#endregion
//#region src/utils/default-values.ts
function R(e) {
	return e.type !== "object" || !e.properties ? {} : Object.entries(e.properties).reduce((e, [t, n]) => n.type === "object" ? {
		...e,
		[t]: R(n)
	} : n.default === void 0 ? {
		...e,
...
function te(e) {
	return e.type === "boolean" ? !1 : e.type === "number" || e.type === "integer" ? 0 : e.type === "array" ? [] : e.type === "string" ? Array.isArray(e.enum) && e.enum.length > 0 ? String(e.enum[0]) : "" : null;
}
//#endregion
//#region src/utils/deep-clone.ts
function ne(e, t, n) {
	return z(e, t.split("."), n);
}
function z(e, t, n) {
	if (t.length === 0) return n;
	let [r, ...i] = t, a = e ?? {}, o = z(a[r], i, n);
	return {
		...a,
		[r]: o
	};
...
//#endregion
//#region src/composables/useFormState.ts
function V() {
	let e = p({});
	function t(t) {
		e.value = R(t);
...
var H = /* @__PURE__ */ O(((e) => {
	...
	var t = K(), n = U(), r = G(), i = { message: "boolean schema is false" };
	function a(e) {
	...
	var t = ie(), n = J(), r = ae(), i = J(), a = oe(), o = se(), s = ce(), c = U(), l = G(), u = X(), d = W(), f = K();
	function p(e) {
		if (S(e) && (w(e), x(e))) {
			_(e);
			return;
	...
	function N(e, t, n, a) {
		...
		if (s.$ref && (p.ignoreKeywordsWithRef || !(0, d.schemaHasRulesButRef)(s, h))) {
			o.block(() => V(e, "$ref", h.all.$ref.definition));
			return;
		}
		p.jtd || F(e, t), o.block(() => {
	...
	function P(e, t) {
		...
		o && (0, a.assignDefaults)(e, t.type), n.block(() => {
			for (let n of t.rules) (0, r.shouldUseRule)(i, n) && V(e, n.keyword, n.definition, t.type);
		});
	}
	function F(e, t) {
	...
	function ee(e, t) {
		...
		for (let i in n) {
			...
			if (typeof a == "object" && (0, r.shouldUseRule)(e.schema, a)) {
				...
				n.length && !n.some((e) => R(t, e)) && z(e, `missing type "${n.join(",")}" for keyword "${i}"`);
			}
		}
	}
	function R(e, t) {
	...
	var H = /^\/(?:[^~]|~0|~1)*$/, re = /^([0-9]+)(#|\/(?:[^~]|~0|~1)*)?$/;
	function q(e, { dataLevel: t, dataNames: n, dataPathArr: r }) {
		let i, a;
		if (e === "") return l.default.rootData;
		if (e[0] === "/") {
			if (!H.test(e)) throw Error(`Invalid JSON-pointer: ${e}`);
	...
	var t = U(), n = de(), r = G(), i = X(), a = W(), o = Z(), s = class {
		constructor(e) {
	...
	required: () => _e,
	type: () => ge
}), me, he, ge, _e, ve, ye, be = D((() => {
	me = "https://raw.githubusercontent.com/ajv-validator/ajv/master/lib/refs/data.json#", he = "Meta-schema for $data reference (JSON AnySchema extension proposal)", ge = "object", _e = ["$data"], ve = { $data: {
		type: "string",
	...
	var { isUUID: n } = xe(), r = /([\da-z][\d\-a-z]{0,31}):((?:[\w!$'()*+,\-.:;=@]|%[\da-f]{2})+)/iu, i = [
		"http",
		"https",
		"ws",
		"wss",
	...
	var { normalizeIPv6: n, removeDotSegments: r, recomposeAuthority: i, normalizeComponentEncoding: a, isIPv4: o, nonSimpleDomain: s } = xe(), { SCHEMES: c, getSchemeHandler: l } = Se();
	function u(e, t) {
	...
	var r = de(), i = Q(), a = q(), o = fe(), s = U(), c = X(), l = J(), u = W(), d = (be(), M(pe).default), f = we(), p = (e, t) => new RegExp(e, t);
	p.code = "new RegExp";
	var m = [
		"removeAdditional",
		"useDefaults",
	...
	var t = Q(), n = Y(), r = U(), i = G(), a = fe(), o = W(), s = {
		keyword: "$ref",
		schemaType: "string",
		code(e) {
	...
	Object.defineProperty(e, "__esModule", { value: !0 });
	var t = ke(), n = Ae(), r = Me(), i = Ne(), a = Pe(), o = Fe(), s = Ie(), c = Re(), l = ze(), u = Be();
	e.default = [
		t.default,
		n.default,
		r.default,
	...
	Object.defineProperty(e, "__esModule", { value: !0 });
	var t = He(), n = We(), r = Ue(), i = Ge(), a = Ke(), o = qe(), s = Je(), c = Ye(), l = Xe(), u = Ze(), d = Qe(), f = $e(), p = et(), m = tt(), h = nt(), g = rt();
	function _(e = !1) {
		let _ = [
			d.default,
			f.default,
	...
	Object.defineProperty(e, "__esModule", { value: !0 }), e.default = [at().default];
})), st = /* @__PURE__ */ O(((e) => {
	...
	title: () => mt,
	type: () => gt
}), ft, pt, mt, ht, gt, _t, vt, yt = D((() => {
	ft = "http://json-schema.org/draft-07/schema#", pt = "http://json-schema.org/draft-07/schema#", mt = "Core schema meta-schema", ht = {
		schemaArray: {
			type: "array",
			minItems: 1,
			items: { $ref: "#" }
	...
	var n = Te(), r = ct(), i = ut(), a = (yt(), M(dt).default), o = ["/properties"], s = "http://json-schema.org/draft-07/schema", c = class extends n.default {
		_addVocabularies() {
	...
	Object.defineProperty(e, "__esModule", { value: !0 });
	var n = xt(), r = St(), i = U(), a = new i.Name("fullFormats"), o = new i.Name("fastFormats"), s = (e, t = { keywords: !0 }) => {
...
})), wt = /* @__PURE__ */ j(bt(), 1), Tt = /* @__PURE__ */ j(Ct(), 1), Et = new wt.default({
	allErrors: !0,
	strict: !1
});
(0, Tt.default)(Et);
	...
	function t(t, n) {
		...
		return r(n) ? (e.value = {
			...
			errors: (r.errors ?? []).map((e) => ({
				path: e.keyword === "required" && e.params?.missingProperty ? e.params.missingProperty : Dt(e.instancePath),
				message: e.message ?? "Invalid value"
			}))
		}, e.value);
	}
	function n(t) {
		return e.value.errors.filter((e) => e.path === t);
	}
	function r(t) {
		return e.value.errors.some((e) => e.path === t);
	}
	function i() {
		e.value = {
			valid: !0,
...
//#endregion
//#region src/utils/file-io.ts
function kt(e, t) {
	let n = JSON.stringify(e, null, 2), r = new Blob([n], { type: "application/json" }), i = URL.createObjectURL(r), a = document.createElement("a");
	a.href = i, a.download = t.endsWith(".json") ? t : `${t}.json`, a.click(), URL.revokeObjectURL(i);
}
//#endregion
//#region src/components/controls/TextInput.vue?vue&type=script&setup=true&lang.ts
var At = [
	"value",
	"placeholder",
	"minlength",
	...
	setup(e) {
		return (t, n) => (f(), i("input", {
			class: u(["form-control", { "has-error": e.hasError }]),
			type: "text",
			value: e.modelValue,
	...
	setup(e) {
		return (t, n) => (f(), i("input", {
			...
			min: e.minimum,
			max: e.maximum,
			onInput: n[0] ||= (e) => t.$emit("update:modelValue", parseFloat(e.target.value))
		}, null, 42, Mt));
	}
}), Pt = { class: "checkbox-wrapper" }, Ft = ["id", "checked"], It = ["for"], Lt = /* @__PURE__ */ c({
	...
	emits: ["update:modelValue"],
	setup(e) {
		let n = e, r = t(() => n.inputId ?? `checkbox-${Math.random().toString(36).slice(2)}`);
		return (t, n) => (f(), i("div", Pt, [a("input", {
			type: "checkbox",
			id: r.value,
			checked: e.modelValue,
			onChange: n[0] ||= (e) => t.$emit("update:modelValue", e.target.checked)
		}, null, 40, Ft), a("label", { for: r.value }, _(e.label), 9, It)]));
	}
}), Rt = ["value"], zt = ["value"], Bt = /* @__PURE__ */ c({
	__name: "SelectInput",
	props: {
		modelValue: {},
		options: {},
	...
	emits: ["update:modelValue"],
	setup(t) {
		return (n, r) => (f(), i("select", {
			class: u(["form-control", { "has-error": t.hasError }]),
			value: t.modelValue,
			onChange: r[0] ||= (e) => n.$emit("update:modelValue", e.target.value)
		}, [(f(!0), i(e, null, m(t.options, (e) => (f(), i("option", {
			key: e.value,
			value: e.value
		}, _(e.label), 9, zt))), 128))], 42, Rt));
	}
}), Vt = ["value", "placeholder"], Ht = /* @__PURE__ */ c({
	...
	key: 0,
	class: "array-empty"
}, Wt = ["value", "onInput"], Gt = ["value", "onInput"], Kt = ["aria-label", "onClick"], qt = /* @__PURE__ */ c({
	__name: "ArrayInput",
	props: {
		modelValue: { default: () => [] },
		itemType: {},
	...
	setup(t, { emit: n }) {
		let o = t, s = n;
		function c() {
			let e = o.itemType === "number" ? 0 : "";
			s("update:modelValue", [...o.modelValue, e]);
		}
		function l(e) {
			s("update:modelValue", o.modelValue.filter((t, n) => n !== e));
		}
		function d(e, t) {
			s("update:modelValue", o.modelValue.map((n, r) => r === e ? t : n));
		}
		return (n, o) => (f(), i("div", { class: u(["array-input", { "has-error": t.hasError }]) }, [
			t.modelValue.length === 0 ? (f(), i("div", Ut, " No items yet. Click \"Add item\" to start. ")) : r("", !0),
			(f(!0), i(e, null, m(t.modelValue, (e, n) => (f(), i("div", {
				key: n,
				class: "array-row"
			}, [t.itemType === "number" ? (f(), i("input", {
				key: 0,
				class: "form-control array-item-input",
				type: "number",
				value: e,
				onInput: (e) => d(n, parseFloat(e.target.value))
			}, null, 40, Wt)) : (f(), i("input", {
				key: 1,
				class: "form-control array-item-input",
				type: "text",
				value: e,
				onInput: (e) => d(n, e.target.value)
			}, null, 40, Gt)), a("button", {
	...
	select: Bt,
	textarea: Ht,
	array: /* @__PURE__ */ $(qt, [["__scopeId", "data-v-46214f73"]])
}, Yt = { class: "field-left" }, Xt = { class: "field-label" }, Zt = {
	key: 0,
	class: "required-mark",
	"aria-label": "required"
}, Qt = {
...
}, $t = { class: "field-right" }, en = {
	key: 0,
	class: "field-errors",
	role: "alert"
}, tn = /* @__PURE__ */ $(/* @__PURE__ */ c({
	__name: "FieldWrapper",
	props: {
		label: {},
		description: {},
	...
	setup(t) {
		return (n, s) => (f(), i("div", { class: u(["field-wrapper", { "has-error": t.hasError }]) }, [a("div", Yt, [a("label", Xt, [o(_(t.label) + " ", 1), t.required ? (f(), i("span", Zt, "*")) : r("", !0)]), t.description ? (f(), i("p", Qt, _(t.description), 1)) : r("", !0)]), a("div", $t, [h(n.$slots, "default", {}, void 0, !0), t.errors.length > 0 ? (f(), i("ul", en, [(f(!0), i(e, null, m(t.errors, (e, t) => (f(), i("li", {
			key: t,
			class: "field-error"
		}, _(e), 1))), 128))])) : r("", !0)])], 2));
	}
}), [["__scopeId", "data-v-34975aa6"]]), nn = { class: "field-group" }, rn = { class: "field-group-legend" }, an = {
	key: 0,
	class: "field-group-description"
}, on = /* @__PURE__ */ $(/* @__PURE__ */ c({
	__name: "FieldGroup",
	props: {
		label: {},
		description: {},
	...
	emits: ["update"],
	setup(e) {
		return (t, n) => (f(), i("fieldset", nn, [
			a("legend", rn, _(e.label), 1),
			e.description ? (f(), i("p", an, _(e.description), 1)) : r("", !0),
			s(sn, {
				fields: e.children,
				config: e.config,
				columns: e.columns,
				onUpdate: n[0] ||= (e) => t.$emit("update", e)
			}, null, 8, [
				"fields",
				"config",
				"columns"
...
}), [["__scopeId", "data-v-cfd171e8"]]), sn = /* @__PURE__ */ $(/* @__PURE__ */ c({
	__name: "FormRenderer",
	props: {
		fields: {},
		config: {},
	...
	emits: ["update"],
	setup(t, { emit: r }) {
		let a = t, o = r, s = l("validationErrors", []);
		function c(e) {
			return (a.errors ?? s).filter((t) => t.path === e).map((e) => e.message);
		}
		function p(e) {
		...
		return (r, a) => (f(), i("div", {
			class: "form-renderer",
			style: d({ "--grid-cols": t.columns })
		}, [(f(!0), i(e, null, m(t.fields, (e) => (f(), i("div", {
			key: e.path,
			class: u(["field-cell", { "field-cell--full": e.controlType === "group" }])
		}, [e.controlType === "group" && e.children ? (f(), n(on, {
			key: 0,
			label: e.label,
			...
			required: e.required,
			errors: c(e.path),
			"has-error": c(e.path).length > 0
		}, {
			default: b(() => [(f(), n(g(v(Jt)[e.controlType]), {
				"model-value": p(e.path),
				"has-error": c(e.path).length > 0,
				options: e.options,
				minimum: e.minimum,
				maximum: e.maximum,
				...
				"onUpdate:modelValue": (t) => _(e.path, t)
			}, null, 8, [
				"model-value",
				"has-error",
				"options",
...
}), [["__scopeId", "data-v-f50e29b6"]]), cn = { class: "toolbar" }, ln = { class: "toolbar-left" }, un = { class: "toolbar-title" }, dn = { class: "toolbar-actions" }, fn = {
	class: "columns-toggle",
	role: "group",
	"aria-label": "Columns"
}, pn = ["onClick"], mn = /* @__PURE__ */ $(/* @__PURE__ */ c({
	__name: "ConfigToolbar",
	props: {
		schemaTitle: {},
		validationResult: {},
		columns: { default: 2 }
	...
	setup(t) {
		return (n, o) => (f(), i("div", cn, [a("div", ln, [a("span", un, _(t.schemaTitle), 1), t.validationResult ? (f(), i("span", {
			key: 0,
			class: u(["validation-badge", t.validationResult.valid ? "badge-valid" : "badge-invalid"])
		}, _(t.validationResult.valid ? "Valid" : `${t.validationResult.errors.length} error(s)`), 3)) : r("", !0)]), a("div", dn, [
			a("div", fn, [o[3] ||= a("span", { class: "toggle-label" }, "列", -1), (f(), i(e, null, m([
				1,
				2,
				3
			], (e) => a("button", {
				key: e,
				class: u(["toggle-btn", { active: t.columns === e }]),
				type: "button",
				onClick: (t) => n.$emit("update:columns", e)
			}, _(e), 11, pn)), 64))]),
			a("button", {
				class: "btn btn-secondary",
				type: "button",
				onClick: o[0] ||= (e) => n.$emit("validate")
			}, " Validate "),
			a("button", {
				class: "btn btn-secondary",
				type: "button",
				onClick: o[1] ||= (e) => n.$emit("reset")
			}, " Reset "),
			a("button", {
				class: "btn btn-primary",
				type: "button",
				onClick: o[2] ||= (e) => n.$emit("export")
			}, " Export JSON ")
		])]));
	}
}), [["__scopeId", "data-v-f9b9ac61"]]), hn = { class: "config-preview" }, gn = { class: "preview-header" }, _n = { class: "preview-code" }, vn = /* @__PURE__ */ $(/* @__PURE__ */ c({
	__name: "ConfigPreview",
	props: { config: {} },
	setup(e) {
		let n = e, r = p(!1), o = t(() => JSON.stringify(n.config, null, 2));
		async function s() {
			try {
				await navigator.clipboard.writeText(o.value), r.value = !0, setTimeout(() => {
					r.value = !1;
				}, 1500);
			} catch {}
		}
		return (e, t) => (f(), i("div", hn, [a("div", gn, [t[0] ||= a("span", { class: "preview-title" }, "JSON Preview", -1), a("button", {
			class: u(["copy-btn", { copied: r.value }]),
			type: "button",
			onClick: s
		}, _(r.value ? "Copied!" : "Copy"), 3)]), a("pre", _n, [a("code", null, _(o.value), 1)])]));
	}
}), [["__scopeId", "data-v-5bea0c7b"]]), yn = { class: "acf-root" }, bn = {
	key: 0,
	class: "acf-error"
}, xn = { class: "acf-form" }, Sn = {
	key: 0,
	class: "acf-preview"
}, Cn = {
	key: 2,
	class: "acf-loading"
}, wn = /* @__PURE__ */ $(/* @__PURE__ */ c({
	__name: "AutoConfigForm",
	props: {
		schema: {},
		schemaUrl: {},
		modelValue: {},
	...
	emits: ["update:modelValue"],
	setup(o, { expose: c, emit: l }) {
		let d = o, m = l, h = p(null), g = p(null), b = p([]), x = p(d.columns), { config: S, initFromSchema: C, setValue: w, reset: T } = V(), { result: E, validate: D, clearErrors: O } = Ot(), k = t(() => d.schema ?? h.value);
		function A(e) {
			b.value = ee(e), C(e), d.modelValue && Object.keys(d.modelValue).length > 0 && (S.value = d.modelValue), O(), m("update:modelValue", S.value);
		}
		y(() => d.schema, (e) => {
			e && A(e);
		}, { immediate: !0 }), y(() => d.schemaUrl, async (e) => {
			if (!(!e || d.schema)) {
				g.value = null;
				try {
					let t = await fetch(e);
					if (!t.ok) throw Error(`HTTP ${t.status}`);
					h.value = await t.json(), A(h.value);
				} catch (e) {
					g.value = e instanceof Error ? e.message : "Failed to load schema";
				}
			}
		}, { immediate: !0 }), y(() => d.modelValue, (e) => {
		...
		function M() {
			k.value && D(k.value, S.value);
		}
		function N() {
			k.value && (T(k.value), O());
		}
		function P() {
			let e = k.value?.title ?? "config";
			kt(S.value, `${e}.json`);
		}
		function F() {
			return k.value ? D(k.value, S.value) : {
				valid: !0,
				errors: []
			};
		}
		...
		return c({
			validate: F,
			reset: I
		}), (t, c) => (f(), i("div", yn, [g.value ? (f(), i("div", bn, _(g.value), 1)) : k.value ? (f(), i(e, { key: 1 }, [o.showToolbar ? (f(), n(mn, {
			key: 0,
			"schema-title": k.value.title ?? "",
			"validation-result": v(E),
			columns: x.value,
			onValidate: M,
			onReset: N,
			onExport: P,
			"onUpdate:columns": c[0] ||= (e) => x.value = e
		}, null, 8, [
			"schema-title",
			"validation-result",
			"columns"
		])) : r("", !0), a("div", { class: u(["acf-body", { "acf-body--split": o.showPreview }]) }, [a("div", xn, [s(sn, {
			fields: b.value,
			config: v(S),
			errors: v(E)?.errors,
			columns: x.value,
			...
			"errors",
			"columns"
		])]), o.showPreview ? (f(), i("div", Sn, [s(vn, { config: v(S) }, null, 8, ["config"])])) : r("", !0)], 2)], 64)) : (f(), i("div", Cn, "Loading schema…"))]));
	}
}), [["__scopeId", "data-v-6a6ade48"]]);
//#endregion
export { wn as AutoConfigForm, R as extractDefaults, ee as parseSchema };
